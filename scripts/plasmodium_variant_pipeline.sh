...
# =============================================================================
# SAMPLE QC SUMMARY
# After FastQC and Trimmomatic, the following samples passed QC per year:
#   2009: 0 samples  (excluded — no samples passed QC)
#   2010: 10 samples
#   2011:  4 samples
#   2012:  7 samples
#   2013: 10 samples
...
#   2017:  6 samples
#   2018: 10 samples
#   TOTAL: 77 samples passed QC and used for downstream WGS analysis
# =============================================================================
